...
//    private enum Digits {
//        private static /* synthetic */ Digits[] $VALUES = null;
...
//            return (Digits) Enum.valueOf(Digits.class, name);
//        }
//
...
//    };
    ...
    private CurrencyEnum(int numeric, Digits digits, String name, CountryCodeEnum[] countries) {
    ...
    public String format(long amount) {
        ...
        switch (this.digits) {
            case DIGITS_0:
                ...
                break;
            case DIGITS_2:
                a = String.valueOf(amount / 100);
                b = String.valueOf(amount % 100);
                while (b.length() < 2) {
                    b = "0" + b;
                }
                formatted = a + "." + b;
                break;
            case DIGITS_3:
                a = String.valueOf(amount / 1000);
                b = String.valueOf(amount % 1000);
                while (b.length() < 3) {
                    b = "0" + b;
                }
                formatted = a + "." + b;
    ...
    public static CurrencyEnum find(String code) {
    ...
    public static CurrencyEnum find(CountryCodeEnum pCountryCodeEnum) {
        ...
        if (pCountryCodeEnum != null) {
            switch (pCountryCodeEnum) {
                ...
                default:
                    for (int i = 0; i < values().length; i++) {
                        for (CountryCodeEnum countrie : values()[i].getCountries()) {
    ...
    public static CurrencyEnum find(CountryCodeEnum CountryCodeEnum, CurrencyEnum defaultCurrency) {
