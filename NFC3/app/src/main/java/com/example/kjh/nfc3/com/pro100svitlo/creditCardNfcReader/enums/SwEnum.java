...
public enum SwEnum {
    ...
    SW_6501("6501", "Write error. Memory failure. There have been problems in writing or reading the EEPROM. Other hardware problems may also bring this error"),
    ...
    private SwEnum(String pStatus, String pDetail) {
        this.status = BytesUtils.fromString(pStatus);
        this.detail = pDetail;
    }
